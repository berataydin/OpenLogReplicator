...
namespace OpenLogReplicator {
    ...
    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1) const {
    ...
    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1, uint64_t byte2) const {
    ...
    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1, uint64_t byte2, uint64_t byte3) const {
        ctx->warning(60008, "can't decode character: (" + std::to_string(byte1) + ", " + std::to_string(byte2) + ", " +
                     std::to_string(byte3) + ") using character set " + name + ", xid: " + xid.toString());
        return UNICODE_UNKNOWN_CHARACTER;
    }

    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1, uint64_t byte2, uint64_t byte3, uint64_t byte4) const {
        ctx->warning(60008, "can't decode character: (" + std::to_string(byte1) + ", " + std::to_string(byte2) + ", " +
                     std::to_string(byte3) + ", " + std::to_string(byte4) + ") using character set " + name + ", xid: " + xid.toString());
        return UNICODE_UNKNOWN_CHARACTER;
    }

    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1, uint64_t byte2, uint64_t byte3, uint64_t byte4, uint64_t byte5) const {
        ctx->warning(60008, "can't decode character: (" + std::to_string(byte1) + ", " + std::to_string(byte2) + ", " +
    ...
    uint64_t CharacterSet::badChar(const Ctx* ctx, Xid xid, uint64_t byte1, uint64_t byte2, uint64_t byte3, uint64_t byte4, uint64_t byte5,
